...
================================
-baseline_ka 
-run_baseline_ka.sh (shell script for temporarily setting environment variables and 
                     executing the application)
   -to run the shell script, type
   
       ./run_baseline_ka.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v91, run the shell script as:
       ...
       ./run_baseline_ka.sh /mathworks/home/application/v91
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_baseline_ka.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
(2) If the environment variable LD_LIBRARY_PATH is undefined, set it to the concatenation 
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_baseline_ka.sh 
