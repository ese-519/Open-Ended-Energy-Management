###########################################################################
## Makefile generated for MATLAB file/project 'mysum'. 
## 
## Makefile     : mysum_rtw.mk
## Generated on : Thu Oct 20 20:07:18 2016
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/mysum.a
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/bobby/dev/IAX-Analytics
ARCH                      = maci64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/mysum.a
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/codegen/lib/mysum -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=mysum -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/codegen/lib/mysum/mysum_initialize.c $(START_DIR)/codegen/lib/mysum/mysum_terminate.c $(START_DIR)/codegen/lib/mysum/mysum.c $(START_DIR)/codegen/lib/mysum/rt_nonfinite.c $(START_DIR)/codegen/lib/mysum/rtGetNaN.c $(START_DIR)/codegen/lib/mysum/rtGetInf.c
...
OBJS = mysum_initialize.o mysum_terminate.o mysum.o rt_nonfinite.o rtGetNaN.o rtGetInf.o
...
%.o : $(START_DIR)/codegen/lib/mysum/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/mysum/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
